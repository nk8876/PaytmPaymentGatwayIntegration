...
//  PaytmIntegrationDemo
//
//  Created by Dheeraj Arora on 20/12/19.
...
class ViewController: UIViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        //mobile number and emain is optional
    ...
    private func getCheckSumAPICall(){
        let apiStruct = ApiStruct(url: "http://192.168.1.212:8888/PHP/generateChecksum.php", method: .post, body: params)
